...
function About() {
  return (
    <div className=' max-md:h-[75vh] h-[80vh] mt-32 max-md:mt-20 '>
      ...
      <div className=' max-md:text-xl ax-md:-mt-14 -mt-20 text-center text-5xl w-[85%] h-full flex flex-col items-center justify-center mx-auto fon-semibold' >
...
<p className=' max-md:text-base text-3xl text-gray-300 max-md:pt-8 pt-16 italic'>
